...
function saveFile(originalAbsolutePath, typeFile) {
  ...
  // const uniqueNameFile = originalAbsolutePath.substring(
  //   originalAbsolutePath.lastIndexOf("\\") + 1,
  //   originalAbsolutePath.length
  // );
  const uniqueNameFile = originalAbsolutePath.split("/")[2];
