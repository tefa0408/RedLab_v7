...
async function getAppointmentsByReferer(req, res) {
  try {
    const query = req.query;
    let appointments = await sAppointment.getAppointmentsByReferer(
      query
    );
    makeResponseOk(res, { data: appointments }, "appointment/listAppointment");
  } catch (err) {
...
async function getAppointmentsByPacient(req, res) {
  try {
    const query = req.query;
    let appointments = await sAppointment.getAppointmentsByPacient(
      query
    );
    makeResponseOk(res, { data: appointments }, "appointment/listAppointment");
  } catch (err) {
...
async function getAppointmentsByDates(req, res) {
  try {
    const query = req.query;
    let appointments = await sAppointment.getAppointmentsByDates(
      query
    );
    makeResponseOk(res, { data: appointments }, "appointment/listAppointment");
  } catch (err) {
