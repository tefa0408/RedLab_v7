...
export const getEmployeesAllApi = (criteria, query) =>
  ...
  export const getEmployeeById = (criteria, query) =>
...
export const getAppointmentsByReferer = (criteria, query, status) =>
apiFetch(`appointment/referer/search?${criteria}=${query}&status=${status}`);

export const getAppointmentsByDates = (start, end, status) =>
apiFetch(`appointment/dates/search?start=${start}&end=${end}&status=${status}`);
  
export const getAppointmentsByPersonId = (personId, status) =>
...
export const getPatientByNameApi = (criteria, name, criteria2, lastNameP) =>
...
export const getExamValueResult = (appointmentDetailId) =>
...
export const getExaminationValuesByExamId = (id, appointmentId) =>
  apiFetch(
    `referenceValue/exam/${id}/${
...
export const editReferenceValueApi = (data, id) =>
  ...
  export const editExamReferenceValueApi = (id, data) =>
  apiFetch(`referenceValue/exam/edit/${id}`, { method: "PUT", body: data });

  export const editExaminationValueApi = (id, data) =>
...
export const reportExamMonthly = (month, year, AgreementId, HeadquarterId) =>
  ...
  export const reportExamByDate = (day, month, year, AgreementId, HeadquarterId) =>
  apiFetch(
