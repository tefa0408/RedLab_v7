...
class PatientExamsTable extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      !_.isEqual(patientExaminations, prevProps.patientExaminations) ||
  ...
  handleMoreExams = () => {
    ...
    if (isMobile) this.props.getPatientExamsMobile(start, end, user_id);
    else this.props.getPatientExams(start, end, user_id);
  };
        ...
        <FuseScrollbars className="flex-grow overflow-x-auto">
          <Table className="min-w-xl" aria-labelledby="tableTitle">
            ...
            <TableBody>
              ...
              {!isLoadingRequest &&
                totalPatientExaminations === 0 && (
                  <TableRow>
                    <TableCell colSpan={3}>
                      <p style={{ fontSize: "20px", textAlign: "center" }}>
                        Resultados no encontradas
                      </p>
                    </TableCell>
                  </TableRow>
                )}
      ...
      <List>
        ...
        {totalPatientExaminations !== data.length && (
          <div style={{ display: "flex", justifyContent: "center" }}>
            <IconButton
              onClick={() => this.handleMoreAgreementsMobile()}
