...
class TemplateToPrint extends React.Component {
  ...
  //         return (
  //           <div>
  //             <h5 className={classes.group}>{n.name}</h5>
    ...
    return (
      <>
        <Grid container>
          ...
          <Grid item xs={6} justify="center">
            <b>{exams.reduce((acc, ex) => acc + ex.price, 0)}</b>
          </Grid>
        </Grid>
      </>
    );
      ...
      <div style={{ margin: "2em;" }} id="print">
        <Grid container spacing={8}>
          ...
          <Grid item xs={12} justify="left">
            <div className={classes.spaceLeft} style={{ marginTop: "10px" }}>
              <Grid container>
                <Grid item xs={6} justify="center">
                  <h3>Examenes</h3>
                </Grid>
          ...
          <Grid item xs={12} justify="center">
            <div className={classes.spaceLeft}>
              {this.renderExams(appointment.examinations)}
            </div>
          </Grid>
          <Grid item xs={12} justify="center">
            <div className={classes.spaceLeft}>
              {this.getTotal(appointment.examinations)}
            </div>
          </Grid>
          ...
          {/* <Grid item xs={8} justify="center">
            <div className={classes.footer}>
              <p>
                <b>CENTRAL</b> {appointment.headquarter.name}
              </p>
              <p>
                <b>Dirección: </b> {appointment.headquarter.address}
              </p>
              <p>
                <b>TELF.:</b> {appointment.headquarter.tlfNumber}
              </p>
              <p>
                <b>EMAIL:</b> administracion@redlabperu.com
              </p>
              <p>
                <b>www.redlabperu.com</b>
              </p>
            </div>
          </Grid>
          <Grid item xs={4}>
