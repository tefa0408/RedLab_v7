...
class ChangePasswordPage extends Component {
  ...
  errorDiferentNewPasswords = () =>
    this.state.form.newPassword !== "" &&
    this.state.form.newPasswordConfirm !== "" &&
    this.state.form.newPassword !== this.state.form.newPasswordConfirm;
                  ...
                  <div>
                    ...
                    >
                      ...
                      <OutlinedInput
                        ...
                        labelWidth={
                          this.labelRef1 ? this.labelRef1.offsetWidth : 0
                        }
                      />
                    </FormControl>
                    <FormControl
                    ...
                    >
                      ...
                      <OutlinedInput
                        ...
                        onChange={this.handleChange}
                        labelWidth={
                          this.labelRef2 ? this.labelRef2.offsetWidth : 0
                        }
                      />
                      <FormHelperText id="component-error-text">
                        {this.errorDiferentNewPasswords() &&
                          this.labelErrorDiferentNewPasswords()}
                      </FormHelperText>
                    </FormControl>
                    <FormControl
                      className={classes.formControl}
                    ...
                    >
                      ...
                      <OutlinedInput
                        ...
                        onChange={this.handleChange}
                        labelWidth={
                          this.labelRef3 ? this.labelRef3.offsetWidth : 0
                        }
                      />
                      <FormHelperText id="component-error-text">
                        {this.errorDiferentNewPasswords() &&
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles, { withTheme: true })(ChangePasswordPage));
