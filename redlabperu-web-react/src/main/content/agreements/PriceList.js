    ...
    fetchExaminations = () => {
        ...
        getExaminationsAllApi().then(response => {
         if (response.status) {
            ...
            // this.state.examinations = response.data;
    ...
    getPriceList = (id) => {
        ...
        getPriceListApi(id).then(response => {
         if (response.status) {
            ...
            this.setState({examinations: this.updatePrices(response.data.examinations)});

            console.log('EXAMINATIONSSSSS');
            console.log(this.state.examinations);
        ...
        const TABLE_COLUMNS = [
            ...
            },
            {
                ...
                render: (discountPrice, row) => {
                    ...
                    // console.log(this.state.examinations); Testando la respuesta a Examinations.
                    return (
                        <NumberFormat 
